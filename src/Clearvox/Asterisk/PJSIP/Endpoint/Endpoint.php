...
class Endpoint implements TypeInterface
{
    ...
    const GLARE_MITIGATION_NONE     = 'none';
    ...
    public function toArray()
    {
        return array(
            ...
            'allow' => $this->allow,
            'direct_media' => $this->directMedia,
            'connected_line_method' => $this->connectedLineMethod,
            'direct_media_method' => $this->directMediaMethod,
            'direct_media_glare_mitigation' => $this->directMediaGlareMitigation,
            'disable_direct_media_on_nat' => $this->disableDirectMediaOnNat,
            'dtmf_mode' => $this->dtmfMode,
            'external_media_address' => $this->externalMediaAddress,
            'force_rport' => $this->forceRport,
            'ice_support' => $this->iceSupport,
            ...
            'rtp_symmetric' => $this->rtpSymmetric,
            'send_diversion' => $this->sendDiversion,
            'send_pai' => $this->sendPai,
            'timers_min_se' => $this->timersMinSe,
            'timers' => $this->timers,
            'timers_sess_expires' => $this->timersSessExpires,
            'callerid' => $this->callerId,
            'callerid_privacy' => $this->callerIdPrivacy,
            'callerid_tag' => $this->callerIdTag,
            '100rel' => $this->oneHundredRel,
            'aggregate_mwi' => $this->aggregateMwi,
            'trust_id_inbound' => $this->trustIdInbound,
            'trust_id_outbound' => $this->trustIdOutbound,
            'use_ptime' => $this->usePTime,
            'use_avpf' => $this->useAVPF,
            'media_encryption' => $this->mediaEncryption,
            'inband_progress' => $this->inbandProgress,
            'call_group' => $this->callGroup,
            'pickup_group' => $this->pickupGroup,
            'named_call_group' => $this->namedCallGroup,
            'named_pickup_group' => $this->namedPickupGroup,
            'device_state_busy_at' => $this->deviceStateBusyAt,
            'fax_detect' => $this->faxDetect,
            't38_udptl' => $this->t38Udptl,
            't38_udptl_ec' => $this->t38UdptlEc,
            't38_udptl_maxdatagram' => $this->t38UdptlMaxDatagram,
            't38_udptl_nat' => $this->t38UdptlNat,
            't38_udptl_ipv6' => $this->t38UdptlIpv6,
            'tone_zone' => $this->toneZone,
            'language' => $this->language,
            'one_touch_recording' => $this->oneTouchRecording,
            'record_on_feature' => $this->recordOnFeature,
            'record_off_feature' => $this->recordOffFeature,
            'rtp_engine' => $this->rtpEngine,
            'allow_transfer' => $this->allowTransfer,
            'allow_subscribe' => $this->allowSubscribe,
            'sdp_owner' => $this->sdpOwner,
            'sdp_session' => $this->sdpSession,
            'tos_audio' => $this->tosAudio,
            'tos_video' => $this->tosVideo,
            'sub_min_expiry' => $this->subMinExpiry,
            'from_domain' => $this->fromDomain,
            'from_user' => $this->fromUser,
            'mwi_fromuser' => $this->mwiFromUser,
            'dtls_verify' => $this->dtlsVerify,
            'dtls_rekey' => $this->dtlsRekey,
            'dtls_cert_file' => $this->dtlsCertFile,
            'dtls_private_key' => $this->dtlsPrivateKey,
            'dtls_cipher' => $this->dtlsCipher,
            'dtls_ca_file' => $this->dtlsCaFile,
            'dtls_ca_path' => $this->dtlsCaPath,
            'dtls_setup' => $this->dtlsSetup,
            'srtp_tag_32' => $this->srtpTag32,
            'media_address' => $this->mediaAddress,
            'redirect_method' => $this->redirectMethod,
            'set_var' => $this->setVar,
            'cos_audio' => $this->cosAudio,
            'cos_video' => $this->cosVideo,
